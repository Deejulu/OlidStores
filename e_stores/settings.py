...
TEMPLATES = [
	{
		...
		'OPTIONS': {
			'context_processors': [
				...
				'products.context_processors.search_categories',
...
# File upload limits - increased for video backgrounds (50MB max)
...
DEFAULT_FROM_EMAIL = os.getenv(
    'DEFAULT_FROM_EMAIL',
    BREVO_SENDER_EMAIL or RESEND_SENDER_EMAIL or EMAIL_HOST_USER or 'webmaster@localhost'
)
