...
class SiteContent(models.Model):
	...
	# Homepage stats are managed with the homepage banner content in the CMS.
	homepage_stat1_label = models.CharField(max_length=100, blank=True)
	homepage_stat2_value = models.CharField(max_length=50, blank=True)
	homepage_stat2_label = models.CharField(max_length=100, blank=True)
	homepage_stat3_value = models.CharField(max_length=50, blank=True)
	homepage_stat3_label = models.CharField(max_length=100, blank=True)
	homepage_stat4_value = models.CharField(max_length=50, blank=True)
	homepage_stat4_label = models.CharField(max_length=100, blank=True)
