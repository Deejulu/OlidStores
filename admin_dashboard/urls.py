...
from .views import (
    ...
    product_list, product_create, product_edit, product_delete, product_toggle, product_bulk_create,
...
urlpatterns = [
    ...
    path('notifications/chat/<int:pk>/mark-read/', admin_chat_mark_read, name='admin_chat_mark_read'),
    path('notifications/feedback/<int:pk>/resolve/', admin_feedback_resolve, name='admin_feedback_resolve'),
    # Live Chat
